...
public class ThSakilaCtrl {
    public static final String[][] ODATA_ENTRY_INFOS = new String[][] { //
            ...
            { "SklActorInfos", "/SklActorInfos?$orderby=last_name,first_name,actor_id&$count=true&$top=20&$skip=3",
                    "VIEW: actor_info" },
            { "SklAddresses", "/SklAddresses?$count=true&$top=20", "TABLE: address" },
            { "SklCategories", "/SklCategories?$count=true&$top=20", "TABLE: category" },
            { "SklCities", "/SklCities?$count=true&$top=20&$orderby=country_id", "TABLE: city" },
            { "SklCountries", "/SklCountries?$count=true&$top=20&$orderby=country", "TABLE: country" },
