...
public class Oiyo14SettingsEntityType {
    ...
    private List<Oiyo14SettingsProperty> property = null;
    @JsonIgnore
    ...
    @JsonProperty("property")
    public List<Oiyo14SettingsProperty> getProperty() {
        return property;
    }

    @JsonProperty("property")
    public void setProperty(List<Oiyo14SettingsProperty> property) {
