...
public class Oiyo13SettingsEntityType {
    ...
    private List<Oiyo13SettingsProperty> property = null;
    @JsonIgnore
    ...
    @JsonProperty("property")
    public List<Oiyo13SettingsProperty> getProperty() {
        return property;
    }

    @JsonProperty("property")
    public void setProperty(List<Oiyo13SettingsProperty> property) {
