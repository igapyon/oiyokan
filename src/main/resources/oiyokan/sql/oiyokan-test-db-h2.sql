...
CREATE TABLE IF NOT EXISTS
  ODataTest5 (
    Iden1 IDENTITY NOT NULL PRIMARY KEY
...
INSERT INTO ODataTest2 (ID, Name, Description, StringVar255, StringLongVar1, Clob1) VALUES (
  1, 'StringTests', '文字列検索確認', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ');
