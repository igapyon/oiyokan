...
class UnitTestTypeUuid01Test {
    ...
    void test01() throws Exception {
        ...
        ODataResponse resp = OiyokanTestUtil.callRequestPost("/ODataTest7", "{\n" //
                + "  \"ID\":" + TEST_ID + "\n" //
                + "}");
        ...
        resp = OiyokanTestUtil.callRequestGetResponse("/ODataTest7(" + TEST_ID + ")", null);
        result = OiyokanTestUtil.stream2String(resp.getContent());
        // System.err.println(result);
        assertEquals(200, resp.getStatusCode(), "INSERTしたレコードが格納されていることを確認.");

        /// 通常のfilter
        resp = OiyokanTestUtil.callRequestGetResponse("/ODataTest7", "$filter=ID eq " + TEST_ID);
        result = OiyokanTestUtil.stream2String(resp.getContent());
        ...
        // DELETE
        resp = OiyokanTestUtil.callRequestDelete("/ODataTest7(" + TEST_ID + ")");
