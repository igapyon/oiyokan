...
class UnitTestTypeBinary01Test {
    ...
    void test01() throws Exception {
        ...
        ODataResponse resp = OiyokanTestUtil.callRequestPost("/ODataTest6", "{\n" //
        ...
        resp = OiyokanTestUtil.callRequestGetResponse("/ODataTest6(" + idString + ")", null);
        result = OiyokanTestUtil.stream2String(resp.getContent());
        // System.err.println(result);
        assertEquals(200, resp.getStatusCode(), "INSERTしたレコードが格納されていることを確認.");

        // UPDATE (PATCH)
        resp = OiyokanTestUtil.callRequestPatch("/ODataTest6(" + idString + ")", "{\n" //
        ...
        /// 通常のfilter
        resp = OiyokanTestUtil.callRequestGetResponse("/ODataTest6", "$filter=ID eq " + idString);
        result = OiyokanTestUtil.stream2String(resp.getContent());
        assertEquals("\"SG91cnl1amku\"", OiyokanTestUtil.getValueFromResultByKey(result, "VarBinary1"),
        ...
        // DELETE
        resp = OiyokanTestUtil.callRequestDelete("/ODataTest6(" + idString + ")");
